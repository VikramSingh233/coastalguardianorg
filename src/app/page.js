...
export default function HomePage() {
  ...
  const checklogin = async () => {
   ...
   if(data.message === "Protected data"){
    setislogin(true); 
   }
  }
    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-blue-50 to-teal-100">
      ...
      <header className="bg-white shadow-md">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <nav className="hidden md:flex space-x-6 mr-25">
            <a  onClick={() => window.scrollTo({ top: 450, behavior: 'smooth' })} className="text-blue-600 font-medium cursor-pointer">Home</a>
            <a  onClick={() =>router.push('/dashboard')} className="text-gray-600 font-medium cursor-pointer">Dashboard</a>
          ...
          }} className="bg-gradient-to-r from-blue-600 to-teal-600 cursor-pointer text-white px-4 py-2 rounded-lg hover:from-blue-700 hover:to-teal-700 transition-all">
            Sign In
          </button>
        </div>
      </header>
    ...
    >
      ...
      <section className="py-16 px-4">
        <div className="container mx-auto text-center">
          ...
          }} className="bg-gradient-to-r from-blue-600 to-teal-600 text-white px-6 py-3 rounded-lg hover:from-blue-700 hover:to-teal-700  cursor-pointer transition-all transform hover:-translate-y-1 shadow-lg">
              Get Started
            </button>
